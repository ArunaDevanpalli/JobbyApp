...
class JobItemDetails extends Component {
  ...
  renderFailureView = () => {
    ...
    return (
      <div className="job-item-error-view-container">
        ...
        />
        <h1 className="jon-item-failure-heading-text">
    ...
    return (
      <div className="job-details-view-container">
        <div className="job-item">
            ...
            <div className="location-package-container">
              <div className="location-employee-container">
                <div className="location-container">
                  <MdLocationOn className="locaton-icon" />
          ...
          <hr className="line" />
          <div className="deription-visit-container">
            <h1 className="decsription-heading">Description</h1>
          ...
          <div className="life-at-company-decsription-image-container">
  ...
  render() {
    return (
      <>
        <Header />
        <div className="jon-item-details-container">
